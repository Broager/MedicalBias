...
def main():
    ...
    train_set = datasets.FreesurferDataset(glob.glob(train_dir + '*.pkl'), transforms=train_composed)
    val_set = datasets.FreesurferDataset(glob.glob(val_dir + '*.pkl'), transforms=val_composed)
